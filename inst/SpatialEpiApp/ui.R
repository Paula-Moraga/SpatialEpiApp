...
fluidRow(
  ...
  column(3, style = "height:750px;  margin:10px; border-style: solid;border-color:gray",
         ...
         hr(), 
         radioButtons("SorSTButton", "Type of analysis", inline=TRUE, c("Spatial" = "S", "Spatio-temporal" = "ST"), selected="S"),
         hr(),
...
fluidRow(column(6, offset=6, verbatimTextOutput("errorsatscannotinstalled"))),
